...
fun DataboxPrimaryButton(
    ...
    val textColor: Color by animateColorAsState(
        if (!enabled) DataboxTheme.colorScheme.buttonTextColor
        else if (isPressed) DataboxTheme.colorScheme.buttonTextColor
        else DataboxTheme.colorScheme.buttonTextColor,
